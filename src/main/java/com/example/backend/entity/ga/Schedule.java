...
import com.example.backend.service.serviceImpl.InstructorCourseServiceImpl;
...
//                List<Instructor> listInstructorOfCourse = service.getListInstructorByIdCourse(course.getId());
